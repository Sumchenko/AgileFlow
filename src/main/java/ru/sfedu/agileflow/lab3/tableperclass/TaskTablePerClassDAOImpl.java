package ru.sfedu.agileflow.lab3.tableperclass;
...
/**
 * Реализация DAO для управления задачами в базе данных с использованием стратегии Table Per Class.
 */
public class TaskTablePerClassDAOImpl implements TaskTablePerClassDAO {
    private static final Logger log = Logger.getLogger(TaskTablePerClassDAOImpl.class);
    ...
    public void create(Task task) {
        ...
        try (EntityManager em = DatabaseConfig.getLab3TablePerClassEntityManager()) {
