...
/**
 * Реализация DAO для управления задачами в базе данных с использованием стратегии Joined Table.
 */
public class TaskJoinedTableDAOImpl implements TaskJoinedTableDAO {
    private static final Logger log = Logger.getLogger(TaskJoinedTableDAOImpl.class);
    ...
    public void create(Task task) {
        ...
        try (EntityManager em = DatabaseConfig.getLab3JoinedTableEntityManager()) {
