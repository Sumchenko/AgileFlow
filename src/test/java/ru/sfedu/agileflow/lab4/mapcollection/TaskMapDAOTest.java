...
/**
 * Тестовый класс для проверки операций DAO с задачами (Map коллекция).
 */
public class TaskMapDAOTest {
    private static final Logger log = Logger.getLogger(TaskMapDAOTest.class);
    private TaskMapDAO taskDAO;
    ...
    public void testCreateTask() {
        ...
        try {
            ...
            task.getComments().put("User1", "Comment 1");
            task.getComments().put("User2", "Comment 2");
    ...
    public void testFindById() {
        ...
        try {
            ...
            assertEquals("Комментарий должен присутствовать", "Comment 1", found.get().getComments().get("User1"));
    ...
    public void testFindAll() {
        ...
        try {
            ...
            task1.getComments().put("User1", "Comment A");
            Task task2 = new Task("Task 2", "Desc 2", TaskStatus.IN_PROGRESS, 2);
            task2.getComments().put("User2", "Comment B");
    ...
    public void testUpdateTask() {
        ...
        try {
            ...
            assertEquals("Новый комментарий должен присутствовать", "Comment 2", updated.get().getComments().get("User2"));
            assertNull("Старый комментарий должен быть удален", updated.get().getComments().get("User1"));
