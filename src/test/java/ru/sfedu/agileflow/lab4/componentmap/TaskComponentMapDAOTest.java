...
/**
 * Тестовый класс для проверки операций DAO с задачами (Map коллекция компонентов).
 */
public class TaskComponentMapDAOTest {
    private static final Logger log = Logger.getLogger(TaskComponentMapDAOTest.class);
    private TaskComponentMapDAO taskDAO;
    ...
    public void setUp() {
        ...
        taskDAO = new TaskComponentMapDAOImpl();
    ...
    public void testCreateTask() {
        ...
        try {
            ...
            task.getAttachments().put("file1", new TaskAttachment("file1.pdf", 1024));
            task.getAttachments().put("file2", new TaskAttachment("file2.png", 2048));
    ...
    public void testFindById() {
        ...
        try {
            ...
            task.getAttachments().put("file1", attachment);
            ...
            assertEquals("Вложение должно присутствовать", attachment, found.get().getAttachments().get("file1"));
    ...
    public void testFindAll() {
        ...
        try {
            ...
            task1.getAttachments().put("file1", new TaskAttachment("file1.pdf", 1024));
            Task task2 = new Task("Task 2", "Desc 2", TaskStatus.IN_PROGRESS, 2);
            task2.getAttachments().put("file2", new TaskAttachment("file2.png", 2048));
    ...
    public void testUpdateTask() {
        ...
        try {
            ...
            task.getAttachments().put("file2", new TaskAttachment("file2.png", 2048));
            task.getAttachments().remove("file1");
            ...
            assertEquals("Новое вложение должно присутствовать", new TaskAttachment("file2.png", 2048), updated.get().getAttachments().get("file2"));
            assertNull("Старое вложение должно быть удалено", updated.get().getAttachments().get("file1"));
