...
/**
 * Тестовый класс для проверки операций DAO с задачами (Set коллекция).
 */
public class TaskSetDAOTest {
    private static final Logger log = Logger.getLogger(TaskSetDAOTest.class);
    private TaskSetDAO taskDAO;
    ...
    public void testCreateTask() {
        ...
        try {
            ...
            task.getComments().add("Comment 1");
            task.getComments().add("Comment 2");
    ...
    public void testFindById() {
        ...
        try {
            ...
            assertTrue("Комментарий должен присутствовать", found.get().getComments().contains("Comment 1"));
    ...
    public void testFindAll() {
        ...
        try {
            ...
            task1.getComments().add("Comment A");
            Task task2 = new Task("Task 2", "Desc 2", TaskStatus.IN_PROGRESS, 2);
            task2.getComments().add("Comment B");
    ...
    public void testUpdateTask() {
        ...
        try {
            ...
            task.getComments().add("Comment 2");
            task.getComments().remove("Comment 1");
            ...
            assertTrue("Новый комментарий должен присутствовать", updated.get().getComments().contains("Comment 2"));
            assertFalse("Старый комментарий должен быть удален", updated.get().getComments().contains("Comment 1"));
