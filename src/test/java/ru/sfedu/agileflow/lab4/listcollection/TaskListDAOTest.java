package ru.sfedu.agileflow.lab4.listcollection;
...
/**
 * Тестовый класс для проверки операций DAO с задачами (List коллекция).
 */
public class TaskListDAOTest {
    private static final Logger log = Logger.getLogger(TaskListDAOTest.class);
    ...
    public void testCreateTask() {
        ...
        try {
            ...
            task.getComments().add("Comment 1"); // Дублирование разрешено
    ...
    public void testFindById() {
        ...
        try {
            ...
            assertEquals("Порядок комментариев должен сохраняться", "Comment 1", found.get().getComments().get(0));
    ...
    public void testUpdateTask() {
        ...
        try {
            ...
            task.getComments().remove(0);
            task.getComments().add("Comment 3");
            ...
            assertEquals("Новый комментарий должен быть на первом месте", "Comment 2", updated.get().getComments().get(0));
