...
/**
 * Тестовый класс для проверки операций DAO с задачами (Single Table).
 */
public class TaskSingleTableDAOTest {
    private static final Logger log = Logger.getLogger(TaskSingleTableDAOTest.class);
    private TaskSingleTableDAO taskDAO;
    ...
    public void setUp() {
        ...
        taskDAO = new TaskSingleTableDAOImpl();
