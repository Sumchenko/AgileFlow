...
/**
 * Тестовый класс для проверки операций DAO с задачами (Table Per Class).
 */
public class TaskTablePerClassDAOTest {
    private static final Logger log = Logger.getLogger(TaskTablePerClassDAOTest.class);
    private TaskTablePerClassDAO taskDAO;
    ...
    public void setUp() {
        ...
        taskDAO = new TaskTablePerClassDAOImpl();
